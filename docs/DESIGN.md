...
> Design notes for **typescript-checkout-oauth-handoff** — a runnable typescript example that Typed storefront checkout login using Google or GitHub OAuth and captcha verification.
...
- **Feature code** — the actual task: storefront checkout auth.
